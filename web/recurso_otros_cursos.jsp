...
<%@page import="ModeloDAO.RecursoDAO"%>
<%@page import="Modelo.RecursoDTO"%>
...
<html lang="es">
    ...
    <head>
        ...
        <title>OTROS CURSOS - RECURSO </title>
    ...
    <body id="page-top"><p><br><p><br><br>
                            ...
                            <ul class="list-unstyled navbar__list">
                                <center>
                                    <li class="C has-sub">
                                        ...
                                        <hr>
                                    <li>
                                        <a href="gestion_otros_cursos.jsp">
                            ...
                            <div class="container-fluid">
                                <div class="header-wrap">
                                    <form class="form-header" action="" method="POST">
                                        <h1 class="titulo_modulo">OTROS CURSOS - RECURSO DEL ESTUDIANTE</h1>
                                        <style>
                                            .titulo_modulo{
                                                color: #FFFFFF;
                                                font-size: 25px;
                        ...
                        <div class="col-xl-12 col-lg-12" class="tabla_servicio">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    ...
                                    <a class="bttn-unite bttn-sm bttn-primary" data-toggle="tooltip" id="mostrar" href="RecursoController?action=insert">AGREGAR</a>
                                ...
                                <div class="card-body">
                                    <div class="chart-area">
                                        ...
                                        <%
                                            RecursoDAO emp = new RecursoDAO();
                                            RecursoDTO recursodto = new RecursoDTO();
                                            ArrayList<RecursoDTO> listar = emp.Listar_RECURSO();
                                        %>

                                        <table id="tblPersonas"  class="table" id="testTable" border="1">
                          <thead class="thead-dark">
                                                <tr>
                                                    <th class="campo">Código de Recurso</th>
                                            ...
                                            <tbody>
                                                <%if (listar.size() > 0) {
                                                        for (RecursoDTO listar2 : listar) {
                                                            recursodto = listar2;
                                                %>
                                                <tr>
                                                    <td><%=recursodto.getCodigopdf()%></td>
                                                    <td>
                                                        <%
                                                            if (recursodto.getArchivopdf2() != null) {
                                                        %>
                                                        <a href="pdfrecurso?IdRecurso=<%=recursodto.getCodigopdf()%>" target="_blank">VISUALIZAR FICHERO</a>
                                                        <%
                                                            } else {
                                                                out.print("Vacío");
                                                            }
                                                    ...
                                                    <td>
                                                        <a href="RecursoController?action=edit&IdRecurso=<%=recursodto.getCodigopdf()%>"> <img class="imagen_edit_pdf" src="pdf/Imagen/editar.png" title="Modificar"/></a> &nbsp;  
                                                        <button onClick="RECURSODELETE(<%=recursodto.getCodigopdf()%>)"> <img class="imagen_edit_pdf" src="pdf/Imagen/borrar.png" title="Eliminar"/></button> &nbsp;  
        ...
        <script>
            function RECURSODELETE(codigopdf) {
                Swal.fire({
                    title: '¿Estas seguro?',
                    ...
                    if (result.value) {
                        location.href = "RecursoController?action=delete&IdRecurso=" + codigopdf;
                    }
                }
                )
            }
