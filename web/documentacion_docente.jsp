...
<head>
    ...
    <!-- Title Page-->
    <title> DOC. LISTA DE CURSOS DOCENTE </title>
                ...
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        <center>
                            ...
                            <a class="js-arrow" href="modulos_docente.jsp">
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <form class="form-header" action="" method="POST">
                                <h1 class="titulo_modulo">LISTA DE CURSOS DOCUMENTACIÓN DOCENTE</h1>
                                    <style>
                                        .titulo_modulo{
                                            color: #FFFFFF;
                                            font-size: 25px;
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <span class="email">Esteban Gómez@prueba2.com</span>
                                                </div>
                                            </div>
                                ...
                                <div class="table-responsive table--no-card m-b-40">
                                    <table class="table table-striped table-earning">
                                        ...
                                        <tbody>
                                             <tr>
                                                <td> 
                                                    <a class="lista_curso" href="documentacion_901_docente.jsp" />Curso 901</a>
                                            </td>
                                            <tr>
                                                <td> 
                                                    <a class="lista_curso" href="documentacion_otros_cursos_docente.jsp" />Curso 902</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <a class="lista_curso" href="documentacion_otros_cursos_docente.jsp" />Curso 903</a>
                                                </td>
                                            </tr>
