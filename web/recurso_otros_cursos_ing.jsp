...
<html lang="es">
    ...
    <head>
        ...
        <title>RECURSE - OTHER COURSES </title>
                            ...
                            <ul class="list-unstyled navbar__list">
                                <center>
                                    <li class="C has-sub">
                                        ...
                                        <hr><br>
                                    <li>
                                        <a href="gestion_otros_cursos_ing.jsp">
                            ...
                            <div class="container-fluid">
                                <div class="header-wrap">
                                    <form class="form-header" action="" method="POST">
                                        <h1 class="titulo_modulo">STUDENT RECURSES - OTHER COURSES</h1>
                                        <style>
                                            .titulo_modulo{
                                                color: #FFFFFF;
                                                font-size: 25px;
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12" class="tabla_servicio">
                          ...
                          <thead class="thead-dark">
                                                <tr>
                                                    <th class="campo">Recurse Code</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        %>
                                                        <a href="pdfrecurso?IdRecurso=<%=recursodto.getCodigopdf()%>" target="_blank">VISUALIZE</a>
                                                        <%
                                                            } else {
                                                                out.print("Empty");
                                                            }
