                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <form class="form-header" action="" method="POST">
                                <h1 class="titulo_modulo"> BOLETAS DE CONSTANCIA SERVICIO CURSOS </h1>
                                    <style>
                                        .titulo_modulo{
                                            color: #FFFFFF;
                                            font-size: 25px;
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="pdf?id=<%=pdfvo.getCodigopdf()%>" target="_blank">
                            <img class="imagen_pdf" src="pdf/Imagen/pdf.png" title="pdf"/>
                        </a>
                    ...
                    <td>
                        <!--<a id="mostrar" href="ControllerPdf?action=insert&id=<%=pdfvo.getCodigopdf()%>"> <img class="imagen_nuev_pdf"  src="pdf/Imagen/agregar.png" title="Nuevo registro"/></a> &nbsp; - &nbsp; -->
                        <a href="ControllerPdf?action=edit&id=<%=pdfvo.getCodigopdf()%>"> <img class="imagen_edit_pdf" src="pdf/Imagen/editar.png" title="Modificar"/></a> &nbsp;  
                        <!--<a href="ControllerPdf?action=delete&id=<%=pdfvo.getCodigopdf()%>"> <img class="imagen_elim_pdf"  src="pdf/Imagen/borrar.png" title="Eliminar"/></a>-->
