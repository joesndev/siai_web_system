            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="gestioning.jsp">
                                <i class="fas fa-copy"></i>Management Academic</a>
                        </li>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <div class="chart-area">
                    <center>
                        <h1> ADD &nbsp; &nbsp;A  &nbsp; &nbsp; NEW  ACTIVITY &nbsp; &nbsp;</h1><p><br>
                            
                            <form class="text-center border border-black p-5" action="CrudGestioning">
                    
                    <div class="form-group">
                        <input type="text" class="form-control" name="txtnombre" required="" placeholder="Activity Name"><br>
                    </div>

                    <div class="form-group">
                        <input type="text" class="form-control" name="txtdescripcion" required="" placeholder=" Activity Description"><br>
                    </div>

                    <div class="form-group">
                       <input type="text" class="form-control" name="txtmateria" required="" placeholder="Credit class"><br>
                    </div>

                    <div class="form-group">
                       <input type="date" class="form-control" name="txtfecha" required="" placeholder="Date"><br>
                    </div>

                    <div class="form-group">
                        <input type="number" min="1" max="10" class="form-control" name="txtperiodo" required="" placeholder="Period"><br>
                    </div>

                    <div class="form-group">
                        <input type="text" class="form-control" name="txtrecurso" required="" placeholder=" Resource Link "><br>
                    </div>
