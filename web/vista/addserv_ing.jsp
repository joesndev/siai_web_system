...
<body id="page-top"><p><br><p><br><br>
  ...
  <div id="wrapper">
   ...
   <!-- Area Chart -->
       ...
       <div class="col-xl-6" class="tabla_servicio">
              ...
              <div class="card shadow mb-6">
                ...
                <div class="card-body">
                  <div class="chart-area">
                      ...
                      <center>
                       <h1> ADD A NEW STUDENT </h1><p><br>
                         </center>   
                            <form class="text-center border border-black p-5" action="CrudServicioing" >
                               
                                <div class="form-group">
                                        <input type="text" class="form-control "  name="txtnombre" required="" placeholder="Name"><br>
                                </div>

                                <div class="form-group">
                                    <input type="text" class="form-control " name="txtapellido" required="" placeholder="Last name"><br>
                                </div>

                                <div class="form-group">
                                <input type="number"  class="form-control" name="txtnumHoras" required="" placeholder="Number of hours"><br>
                                </div>

                                <div class="form-group">
                                        <input type="text" class="form-control " name="txtdrive" required="" placeholder="Drive link"><br>
                                </div>

                                
                                <div class="form-group">
                                    <label>Attach file<span class="required">*</span></label>
					<div class="inputs">
                                ...
                                <div class="form-group">
                                        <input type="text" class="form-control " name="txtNombreEntidad" required="" placeholder="Entity in which he made"><br>
                                </div>
