...
<head>
  ...
  <!-- Bootstrap CSS-->
    ...
    <title> EDITAR DATOS DEL DOCUMENTADO </title>
   ...
   <center>
       <div class="col-xl-10 col-lg-10" class="tabla_servicio">
            ...
            <%
              ...
              int idDocumentacion=Integer.parseInt((String)request.getAttribute("iddoc"));
              Documentacion d=(Documentacion)dao.list(idDocumentacion);
            %>    
           <div class="estilo_tabla">
                          <h1> EDITAR LOS DATOS DEL ESTUDIANTE DOCUMENTADO</h1><p><br>
                              
            <form  class="text-center border border-black p-5 "action="CrudDocumentacion">
                
                <div class="form-group"><p><P>
                        <input type="text" value="<%=d.getNombre()%>" class="form-control" name="txtnombre"  placeholder="Nombre" required=""><br>
                </div>
                
                <div class="form-group"> 
                    <input type="text" value="<%=d.getApellido()%>" class="form-control" name="txtapellido" placeholder="Apellido"><br>
                </div>
                
                <div class="form-group">
                        <input type="text" class="form-control" value="<%=d.getAcudiente()%>" name="txtacudiente" placeholder="Acudiente" required=""><br>
                </div>
                
                <!--
                    <div class="form-group">
                            <input type="text" class="form-control" value="<%=d.getMatricula()%>" name="txtmatricula" placeholder="Matricula" required=""><br>
                    </div>

                    <div class="form-group">
                            <input type="text" class="form-control" value="<%=d.getSalud()%>" name="txtsalud" placeholder="Salud" required=""><br>
                    </div>

                    <div class="form-group">
                        <input type="text" class="form-control" value="<%=d.getBoletin()%>" name="txtBoletin" placeholder="Boletin" required=""><br>
                    </div>-->


                    <div class="form-group">
                            <input type="hidden" class="form-control" value="<%=d.getIdDocumentacion()%>"  name="txtidDocumentacion" ><br>
                    </div>
