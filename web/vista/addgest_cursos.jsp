...
<head>
  ...
  <!-- Bootstrap CSS-->
    ...
    <title> AÑADIR ACTIVIDAD OTROS CURSOS </title>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <div class="chart-area">
                    <center>
                       <h1> AGREGAR UNA NUEVA ACTIVIDAD</h1><p><br>
                            
                            <form class="text-center border border-black p-5" action="CrudGestion_cursos">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="txtdescripcion" required="" placeholder="Descripcion"><br>
                    </div>

                    <div class="form-group">
                       <input type="text" class="form-control" name="txtmateria" required="" placeholder="Materia"><br>
                    </div>

                    <div class="form-group">
                       <input type="date" class="form-control" name="txtfecha" required="" placeholder="Fecha"><br>
                    </div>

                    <div class="form-group">
                        <input type="number" min="1" max="10" class="form-control" name="txtperiodo" required="" placeholder="Periodo"><br>
                    </div>

                    <div class="form-group">
                        <input type="text" class="form-control" name="txtrecurso" required="" placeholder="Link del Recurso"><br>
                    </div>
