  ...
  <div id="wrapper">
   ...
   <center>
       <div class="col-xl-10 col-lg-10" class="tabla_servicio">
              ...
              int idUsuario=Integer.parseInt((String)request.getAttribute("ID"));
              Usuario u=(Usuario)dao.list(idUsuario);
            %>    
            
            <div class="estilo_tabla"><br>
                          <h1> EDITAR LOS DATOS DEL USUARIO </h1><p><br>
                              
                          <form class="text-center border border-black p-5" action="ControladorUsuario" method="POST">
                
                <div class="form-group"><p><P>
                    <input type="text" value="<%=u.getNombre()%>" class="form-control" name="txtnombre" required="" placeholder="Nombre"><br>
                </div>
                
                <div class="form-group">
                    <input type="text" value="<%=u.getApellido()%>" class="form-control" name="txtapellido" required="" placeholder="Apellido"><br>
                </div>
                
                <div class="form-group">
                    <input type="number" class="form-control" value="<%=u.getNumeroDocumento()%>" name="txtnumerodoc" required="" placeholder="Numero de documento"><br>
                </div>
                
                 <div class="form-group">
                        <input type="text" class="form-control" value="<%=u.getCorreo()%>" name="txtcorreo" required="" placeholder="Correo"><br>
               </div>
                
                <div class="form-group">
                    <input type="number" min="1000000000" class="form-control" value="<%=u.getTelefono()%>" name="txttelefono" required="" placeholder="Telefono"><br>
                </div>
                
                <div class="form-group">
                    <input type="text" class="form-control" value="<%=u.getTipoUsuario()%>" name="txttipousuario" required="" placeholder="Tipo de Usuario"><br>
                </div>
                
                <div class="form-group">
                    <input type="text" class="form-control"  value="<%=u.getClave()%>"name="txtclave" required="" placeholder="Telefono"><br>
                </div> 
                ...
                <div class="form-group">
                    <input type="hidden" class="form-control" value="<%=u.getTipo_doc_Id()%>" placeholder="1:T.I, 2:CC, 3:RC" name="txtiddoc"><br>
                </div>
