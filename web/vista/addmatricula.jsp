  ...
  <div id="wrapper">
    ...
    <!-- PAGE CONTAINER-->
        ...
        <%
                        Integer dato = 0;
                        try {
                            Matricula pdf = (Matricula) request.getAttribute("row");
                    ...
                    <form name="formpdf" action="ControladorMatricula" method="post" enctype="multipart/form-data">
                            <div class="datagrid">
                                ...
                                <style>
                                        .form-control{
                                            ...
                                            text-align: center;
                                                ...
                                                <%
                                                    if (icono) {
                                                %>
                                                <a href="pdfmatricula?IdMatricula=<%out.print(dato); %>" target="_blank">Visualizar PDF</a>
                                                <%
                                                    } else {
                                        ...
                                        <tr>
                                            ...
                                            <input type="submit" value="ACTUALIZAR" name="submit" id="btn" class="btn btn-primary"/></td>                
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
