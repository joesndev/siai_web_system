              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <div class="chart-area">
                    <center>
                       <h1> AGREGAR UN NUEVO DOCUMENTO </h1><p><br>
                            
                              <form  class="text-center border border-black p-5" action="CrudDocumentacion">
                
                <div class="form-group">
                    <input type="text" class="form-control" name="txtnombre" required="" required="" placeholder="Nombre"><br>
                </div>
                ...
                <div class="form-group">
                    <input type="text" class="form-control" name="txtacudiente" required="" placeholder="Acudiente"><br>
                </div>
                                
                <div class="form-group">
                    <label>Adjuntar Fotocopia cedula acudiente<span class="required">*</span></label>
			<div class="inputs">
                            <input class="form-control"  type="file" name="txtmatricula" size="70" accept="text/plain;image/jpeg">
                        </div>
                </div><br> 
                                  
                <div class="form-group">
                    <label>Adjuntar archivo Certificado de salud<span class="required">*</span></label>
			<div class="inputs">
                            <input class="form-control"  type="file" name="txtsalud" size="70" accept="text/plain;image/jpeg">
                        </div>
                </div><br>     
                                                                
                <div class="form-group">
                    <label>Adjuntar archivo ultimo boletin<span class="required">*</span></label>
			<div class="inputs">
                            <input class="form-control"  type="file" name="txtboletin" size="70" accept="text/plain;image/jpeg">
                        </div>
                </div> <br>                 
                
                
                <center><input class="btn btn-outline-info btn-md" type="submit" name="accion" value="Agregar"></center>
            </form>
                </div>
              </div>
            </div>
