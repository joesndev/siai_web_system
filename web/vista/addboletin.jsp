...
<html>
    ...
    <body>
        <%
                        Integer dato = 0;
                        try {
                            Boletin pdf = (Boletin) request.getAttribute("row");
                    ...
                    <form name="formpdf" action="ControladorBoletin" method="post" enctype="multipart/form-data">
                            <div class="datagrid">
                                <table style="width: 100%; height: 100px;">
                                    ...
                                    <tbody>
                                        <tr class="alt">
                                            <td></td>
                                            <td>
                                                <label for="IdBoletin"></label>
                                                <%
                                                    if (icono) {
                                                %>
                                                <a href="pdfboletin?IdBoletin=<%out.print(dato); %>" target="_blank">Visualizar PDF</a>
                                                <%
                                                    } else {
