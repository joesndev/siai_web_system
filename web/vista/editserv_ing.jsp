                ...
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        <center>
                            ...
                            <hr>
                          <li>
                            <a href="serviciosocialing.jsp">
                                <i class="fas fa-fast-backward"></i>Return</a>
                          </li>
   ...
   <center>
       <div class="col-xl-10 col-lg-10" class="tabla_servicio">
            ...
            <%
              ...
              int idServicioSocial=Integer.parseInt((String)request.getAttribute("idser"));
              ServicioIng s=(ServicioIng)dao.list(idServicioSocial);
                %>   
                
                <div class="estilo_tabla"><br>
                          <h1>EDIT STUDENT REGISTRATION </h1><p><br>
                <form class="text-center border border-black p-5" action="CrudServicioing   ">
                
                <div class="form-group"><p><P>
                        <input type="text" value="<%=s.getNombre()%>" class="form-control" required="" name="txtnombre" ><br>
                </div>
                
                <div class="form-group">
                    <input type="text" value="<%=s.getApellido()%>" class="form-control" required="" name="txtapellido"><br>
                </div>
                
                <div class="form-group">
                    <input type="number" class="form-control" value="<%=s.getNumHoras()%>" required="" name="txtnumHoras"><br>
                </div>
                
                <div class="form-group">
                    <input type="text" class="form-control" value="<%=s.getDrive()%>" required="" name="txtdrive"><br>
                </div>
                
                <div class="form-group">
                    <input type="text" class="form-control" value="<%=s.getFirma()%>" required="" name="txtfirma"><br>
                </div>
                
                <div class="form-group">
                   <input type="text" class="form-control" value="<%=s.getNombreEntidad()%>" required="" name="txtNombreEntidad"><br>
                </div>
                
                
                <input type="hidden" name="txtidServicioSocial" value="<%=s.getIdServicioSocial()%>" readonly="">
