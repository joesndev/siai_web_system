   ...
   <center>
       <div class="col-xl-10 col-lg-10" class="tabla_servicio">
            ...
            <%
              ...
              Servicio s=(Servicio)dao.list(idServicioSocial);
                %>   
                <div class="estilo_tabla"><br>
                          <h1> EDITAR DATOS DEL ESTUDIANTE </h1><p><br>
                <form class="text-center border border-black p-5" action="CrudServicio">
                ...
                <div class="form-group">
                    <inp<ut type="text" value="<%=s.getApellido()%>" class="form-control" required="" name="txtapellido"><br>
                </div>-->
