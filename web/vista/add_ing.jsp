                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            ...
                                            <div class="account-dropdown__footer">
                                                <a href="index_ing.html">
                                                    <i class="zmdi zmdi-power"> Cerrar Sesión</i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
   ...
   <center>
       <div class="col-xl-10 col-lg-10" class="tabla_servicio">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="form-group">
                               <label for="pillSelect">Document type</label>
                ...
                <div class="form-group">
                    <input type="number" id="documento" class="form-control" min="1000000" max="999999999999" name="txtnumerodoc"  placeholder="Document number"><br>
                </div>
                ...
                <div class="form-group">
                    <input type="number" id="telefono" class="form-control" name="txttelefono"  placeholder="Phone "><br>
                </div>
                
                <div class="form-group">
                    <input type="text" id="clave" class="form-control" name="txtclave" placeholder="Password"><br>
                </div>
