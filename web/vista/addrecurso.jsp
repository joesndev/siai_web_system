        ...
        <div class="page-container">
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <form class="form-header" action="" method="POST">
                                <h1 class="titulo_modulo">LISTA DE RECURSOS DISPONIBLES</h1>
                                    <style>
                                        .titulo_modulo{
                                            color: #FFFFFF;
                                            font-size: 25px;
            ...
            <div class="container-fluid">
                ...
                <%
                        Integer dato = 0;
                        try {
                            RecursoDTO pdf = (RecursoDTO) request.getAttribute("row");
                ...
                <!-- Card Body -->
                <div class="card-body">
                    <form name="formpdf" action="RecursoController" method="post" enctype="multipart/form-data">
                       ...
                       <table id="tblPersonas"  class="table" id="testTable" border="1">
                          <thead class="thead-dark">
                                ...
                                <tr>
                                        ...
                                        <tr>
                                            <td>
                                                <label for="IdRecurso"></label>
                                                <%
                                                    if (icono) {
                                                %>
                                                <a  href="pdfrecurso?IdRecurso=<%out.print(dato); %>" target="_blank">VISUALIZAR PDF</a>
                                                <%
                                                    } else {
                                            ...
                                            <td colspan="2" style="text-align: center">
                                                <button type="submit" value="Enviar Archivo" name="submit" id="btn" class="bttn-unite bttn-sm bttn-primary">CARGAR RECURSO</button>
