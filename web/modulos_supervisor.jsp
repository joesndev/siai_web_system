...
<html lang="es">  
    <head>
        <meta charset="utf-8">
        <title>MODULOS SUPERVISOR</title>
                        ...
                        <section id="about">
                            <div class="container">
                                ...
                                <header class="section-header">
                                    <h3>MÓDULO</h3>
                                    <p> A continuación encontrara el módulo de servicio social al cual puede acceder: </p>
                                </header>
                                    ...
                                    <div class="col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                                        <div class="about-col">
                                            ...
                                            <h2 class="title"><a href="#">Servicio Social </a></h2>
                                                ...
                                                <button class="bttn-jelly bttn-sm bttn-primary" onclick="location.href = 'servicio_estudiante_supervisor.jsp'" data-toggle="tooltip" title="INGRESAR AL MODULO SERVICIO SOCIAL">
                                                    INGRESAR
                                                </button>
