...
<head>
    ...
    <!-- Title Page-->
    <title> DOC. LISTA DE CURSOS </title>
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <form class="form-header" action="" method="POST">
                                <h1 class="titulo_modulo">LISTA DE CURSOS DOCUMENTACIÒN</h1>
                                    <style>
                                        .titulo_modulo{
                                            color: #FFFFFF;
                                            font-size: 25px;
                                ...
                                <div class="table-responsive table--no-card m-b-40">
                                    <table class="table table-striped table-earning">
                                        ...
                                        <tbody>
                                             <tr>
                                                <td> 
                                                    <a class="lista_curso" href="documentacion_901.jsp" />Curso 901</a>
                                            </td>
                                            <tr>
                                                <td> 
                                                    <a class="lista_curso" href="documentacion_otros_cursos.jsp" />Curso 902</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <a class="lista_curso" href="documentacion_otros_cursos.jsp" />Curso 903</a>
                                                </td>
                                            </tr>
