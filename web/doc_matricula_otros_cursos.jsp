                            ...
                            <ul class="list-unstyled navbar__list">
                                <center>
                                    <li class="C has-sub">
                                        ...
                                        <hr>
                                    <li>
                                        <a href="documentacion_otros_cursos.jsp">
                            ...
                            <div class="container-fluid">
                                <div class="header-wrap">
                                    <form class="form-header" action="" method="POST">
                                        <h1 class="titulo_modulo">MATRICULA DEL ESTUDIANTE</h1>
                                        <style>
                                            .titulo_modulo{
                                                color: #FFFFFF;
                                                font-size: 25px;
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="chart-area">
                                        ...
                                        <%
                                            MatriculaDAO emp = new MatriculaDAO();
                                            Matricula matriculadto = new Matricula();
                                            ArrayList<Matricula> listar = emp.Listar_matricula();
                                        %>

                                        <table id="tblPersonas"  class="table" id="testTable" border="1">
                          <thead class="thead-dark">
                                                <tr>
                                                    <th class="campo">Código de matricula</th>
                                            ...
                                            <tbody>
                                                <%if (listar.size() > 0) {
                                                        for (Matricula listar2 : listar) {
                                                            matriculadto = listar2;
                                                %>
                                                <tr>
                                                    <td><%=matriculadto.getCodigopdf()%></td>
                                                    <td>
                                                        <%
                                                            if (matriculadto.getArchivopdf2() != null) {
                                                        %>
                                                        <a href="pdfmatricula?IdMatricula=<%=matriculadto.getCodigopdf()%>" target="_blank">PDF</a>
                                                        <%
                                                            } else {
                                                                out.print("Vacío");
                                                            }
                                                    ...
                                                    <td>
                                                        <a href="ControladorMatricula?action=edit&IdMatricula=<%=matriculadto.getCodigopdf()%>"> <img class="imagen_edit_pdf" src="pdf/Imagen/editar.png" title="Modificar"/></a> &nbsp;  
