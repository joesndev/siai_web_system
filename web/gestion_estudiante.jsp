...
<head>
  ...
  <!-- Bootstrap CSS-->
    ...
    <title>ESTUDIANTE - GESTION CURSO 901 </title>
            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="documentacion_estudiante.jsp">
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <form class="form-header" action="" method="POST">
                               <h1 class="titulo_modulo">ESTUDIANTE - LISTA DE ACTIVIDADES GESTIÒN</h1>
                                    <style>
                                        .titulo_modulo{
                                            color: #FFFFFF;
                                            font-size: 25px;
                             ...
                             <tr>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="recurso_estudiante.jsp" class="bttn-unite bttn-sm bttn-danger" data-toggle="tooltip" title="ABRIR ARCHIVO DE RECURSO">
                                                        VER DOCUMENTO
                                                    </a><p>
