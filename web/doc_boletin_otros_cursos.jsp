...
<%@page import="ModeloDAO.BoletinDAO"%>
                            ...
                            <div class="container-fluid">
                                <div class="header-wrap">
                                    <form class="form-header" action="" method="POST">
                                        <h1 class="titulo_modulo">BOLETÍN DEL ESTUDIANTE</h1>
                                        <style>
                                            .titulo_modulo{
                                                color: #FFFFFF;
                                                font-size: 25px;
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="chart-area">
                                        ...
                                        <%
                                            BoletinDAO emp = new BoletinDAO();
                                            Boletin boletindto = new Boletin();
                                            ArrayList<Boletin> listar = emp.Listar_BOLETIN();
                                        %>

                                        <table id="tblPersonas"  class="table" id="testTable" border="1">
                          <thead class="thead-dark">
                                                <tr>
                                                    <th class="campo">Código de Boletín</th>
                                            ...
                                            <tbody>
                                                <%if (listar.size() > 0) {
                                                        for (Boletin listar2 : listar) {
                                                            boletindto = listar2;
                                                %>
                                                <tr>
                                                    <td><%=boletindto.getCodigopdf()%></td>
                                                    <td>
                                                        <%
                                                            if (boletindto.getArchivopdf2() != null) {
                                                        %>
                                                        <a href="pdfboletin?IdBoletin=<%=boletindto.getCodigopdf()%>" target="_blank">PDF</a>
                                                        <%
                                                            } else {
                                                                out.print("Vacío");
                                                            }
                                                    ...
                                                    <td>
                                                        <a href="ControladorBoletin?action=edit&IdBoletin=<%=boletindto.getCodigopdf()%>"> <img class="imagen_edit_pdf" src="pdf/Imagen/editar.png" title="Modificar"/></a> &nbsp;  
