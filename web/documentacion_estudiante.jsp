...
<head>
  ...
  <!-- Bootstrap CSS-->
    ...
    <title>ESTUDIANTE - DOCUMENTACION CURSO 901 </title>
                ...
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        <center>
                            ...
                            <li>
                            <a href="biblioteca_estudiante.jsp">
                                <i class="fa fa-book-reader"></i>Biblioteca Virtual</a>
                        </li>
                        <li>
                                <a href="gestion_estudiante.jsp">
                                    <i class="fas fa-copy"></i> Gestion Academica </a>
                                    </li>
                                    <li>
                                <a  href="servicio_estudiante_901.jsp">
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <form class="form-header" action="" method="POST">
                                <h1 class="titulo_modulo">ESTUDIANTE - LISTA DE DOCUMENTOS</h1>
                                    <style>
                                        .titulo_modulo{
                                            color: #FFFFFF;
                                            font-size: 25px;
                              ...
                              <form action="CargaMasivaDocumentacion" enctype="multipart/form-data" method="post">
                               ...
                               <!-- FILTRO = LABEL / INPUT -->
                                    <label class="label_filtrar"> Filtrar: </label>
                                        <input class="input_filtrar_estudiante" id="txtBusqueda" type="text" onkeyup="Buscar();" data-toggle="tooltip" title="FILTRAR DATOS REGISTRADOS" /> &nbsp; &nbsp;   
                                        <style>
                                            
                                            .input_filtrar_estudiante{
                                                width: 60%;
                                                border: 1px solid;
                                                border-radius: 8px;
                                            }
                             ...
                             <tr>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="doc_matricula_estudiante.jsp" class="bttn-unite bttn-sm bttn-danger" data-toggle="tooltip" title="VER DOCUMENTO DE MATRICULA">
                                                        VER DOCUMENTO
                                                    </a>
                                                </td> 
                                                
                                                <td>
                                                    <a href="doc_eps_estudiante.jsp" class="bttn-unite bttn-sm bttn-danger" data-toggle="tooltip" title="VER CERTIFICADO DE SALUD EPS ">
                                                        VER DOCUMENTO
                                                    </a>
                                                </td> 
                                                
                                                <td>
                                                    <a href="doc_boletin_estudiante.jsp" class="bttn-unite bttn-sm bttn-danger" data-toggle="tooltip" title="VER DOCUMENTO ULTIMO BOLETIN">
                                                        VER DOCUMENTO
                                                    </a>
                                                </td> 
