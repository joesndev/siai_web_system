...
<head>
  ...
  <!-- Bootstrap CSS-->
    ...
    <title> 901 COURSE - MANAGEMENT </title>
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <form class="form-header" action="" method="POST">
                               <h1 class="titulo_modulo">ACTIVITY LIST - MANAGEMENT</h1>
                                    <style>
                                        .titulo_modulo{
                                            color: #FFFFFF;
                                            font-size: 25px;
                             ...
                             <tr>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="recurso_ing.jsp" class="bttn-unite bttn-sm bttn-danger" data-toggle="tooltip" title="ABRIR ARCHIVO DE RECURSO">
                                                        SEE DOCUMENT
                                                    </a><p>
