...
<head>
  ...
  <!-- Bootstrap CSS-->
    ...
    <title> DOCUMENTACION OTROS CURSOS - DOCENTE</title>
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <form class="form-header" action="" method="POST">
                                <h1 class="titulo_modulo">LISTA DE ESTUDIANTES OTROS CURSOS - DOCENTE</h1>
                                    <style>
                                        .titulo_modulo{
                                            color: #FFFFFF;
                                            font-size: 25px;
                             ...
                             <tr>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="" class="bttn-unite bttn-sm bttn-danger" data-toggle="tooltip" title="VER DOCUMENTO DE MATRICULA">
                                                        PDF
                                                    </a>
                                                </td> 
                                                
                                                <td>
                                                    <a href="" class="bttn-unite bttn-sm bttn-danger" data-toggle="tooltip" title="VER CERTIFICADO DE SALUD EPS ">
                                                        PDF
                                                    </a>
                                                </td> 
                                                
                                                <td>
                                                    <a href="" class="bttn-unite bttn-sm bttn-danger" data-toggle="tooltip" title="VER DOCUMENTO ULTIMO BOLETIN">
                                                        PDF
                                                    </a>
                                                </td> 
