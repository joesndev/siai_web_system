...
<head>
  ...
  <!-- Bootstrap CSS-->
    ...
    <title> DOCUMENTACION CURSO 901 </title>
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <form class="form-header" action="" method="POST">
                                <h1 class="titulo_modulo"> DOCUMENT REGISTRATION </h1>
                                    <style>
                                        .titulo_modulo{
                                            color: #FFFFFF;
                                            font-size: 25px;
                    ...
                    <div class="col-xl-12 col-lg-12" class="tabla_servicio">
                        <div class="card shadow mb-4">
                              ...
                              <form action="CargaMasivaDocumentacion" enctype="multipart/form-data" method="post">
                                ...
                                <!-- FILTRO = LABEL / INPUT -->
                                        <label class="label_filtrar"> Search :</label> &nbsp; &nbsp; 
                                            <input class="input_filtrar" id="txtBusqueda" type="text" onkeyup="Buscar();" data-toggle="tooltip" /> &nbsp; &nbsp;   
                       ...
                       <table id="tblPersonas" class="table" id="testTable" border="1">
                          <thead class="thead-dark">
                             <tr>
                                                ...
                                                <th class="campo">NAME AND LAST NAME </th>
                                                <th class="campo">REGISTRATION DOCUMENT</th>
                                                <th class="campo">HEALTH CERTIFICATE</th>
                                                <th class="campo">DOCUMENT BULLETIN</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="doc_matricula_ing.jsp" class="bttn-unite bttn-sm bttn-danger" data-toggle="tooltip" title="SEE DOCUMENT">
                                                        SEE DOCUMENT
                                                    </a>
                                                </td> 
                                                
                                                <td>
                                                    <a href="doc_eps_ing.jsp" class="bttn-unite bttn-sm bttn-danger" data-toggle="tooltip" title="SEE DOCUMENT">
                                                        SEE DOCUMENT
                                                    </a>
                                                </td> 
                                                
                                                <td>
                                                    <a href="doc_boletin_ing.jsp" class="bttn-unite bttn-sm bttn-danger" data-toggle="tooltip" title="SEE DOCUMENT">
                                                        SEE DOCUMENT
                                                    </a>
                                                </td> 
