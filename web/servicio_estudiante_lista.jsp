                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="gestion_cursos.jsp">
                                <i class="fas fa-folder"></i> Gestión Académica </a>
                        </li>
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <form class="form-header" action="" method="POST">
                                <h1 class="titulo_modulo">LISTA DE ESTUDIANTES REALIZANDO SERVICIO SOCIAL</h1>
                                    <style>
                                        .titulo_modulo{
                                            color: #FFFFFF;
                                            font-size: 25px;
                                ...
                                <div class="table-responsive table--no-card m-b-40">
                                    <table class="table table-striped table-earning">
                                        ...
                                        <tbody>
                                             ...
                                             <tr>
                                                <td> 
                                                    <a class="lista_curso" href="serviciosocial.jsp" />Esteban Danilo Rojas Gomez</a>
                                                </td>
                                                <td> 
                                                    <a class="lista_curso" href="servicio_cursos.jsp" />Sujeto estudiante prueba</a>
                                                </td>
                                                <td>
                                                    <a class="lista_curso" href="servicio_cursos.jsp" />Sujeto estudiante prueba</a>
                                                </td>
                                            ...
                                            <tr>
                                                <td> 
                                                    <a class="lista_curso" href="servicio_cursos.jsp" />Sebastian Felipe Romero Moreno</a>
                                                </td>
                                                <td> 
                                                    <a class="lista_curso" href="servicio_cursos.jsp" />Sujeto estudiante prueba</a>
                                                </td>
                                            ...
                                            <tr>
                                                <td> 
                                                    <a class="lista_curso" href="servicio_cursos.jsp" />Johan Sneider Chavez Machado</a>
                                                </td>
                                                <td> 
                                                    <a class="lista_curso" href="servicio_cursos.jsp" />Sujeto estudiante prueba</a>
                                                </td>
                                            ...
                                            <tr>
                                                <td> 
                                                    <a class="lista_curso" href="servicio_cursos.jsp" />Wilmer Camilo Hernandez Avila</a>
                                                </td>
                                                <td> 
                                                    <a class="lista_curso" href="servicio_cursos.jsp" />Sujeto estudiante prueba</a>
                                                </td>
