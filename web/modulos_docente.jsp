            ...
            <div class="about-col">
              <div class="img">
                ...
                <center> 
                    ...
                    <button class="bttn-jelly bttn-sm bttn-primary" onclick="location.href='documentacion_docente.jsp'" data-toggle="tooltip" title="INGRESAR AL MODULO DOCUMENTACIÓN">
                        INGRESAR
                    </button>
            ...
            <div class="about-col">
              ...
              <h2 class="title"><a href="#"> Gestión Academica </a></h2>
                <center> 
                    ...
                    <button class="bttn-jelly bttn-sm bttn-primary" onclick="location.href='gestion_cursos_docente.jsp'"  data-toggle="tooltip" title="INGRESAR AL MODULO SERVICIO SOCIAL">
                        INGRESAR
                    </button>
            ...
            <div class="about-col">
              <div class="img"> 
                ...
                <center> 
                    ...
                    <button class="bttn-jelly bttn-sm bttn-primary" onclick="location.href='biblioteca_docente.jsp'"  data-toggle="tooltip" title="INGRESAR AL MODULO SERVICIO SOCIAL">
                        INGRESAR
                    </button>
