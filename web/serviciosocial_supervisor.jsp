...
<html lang="es">
    ...
    <head>
        ...
        <title> SUPERVISOR - SERVICIO CURSO 901 </title>
                                        ...
                                        <div class="container-fluid">
                                            <div class="header-wrap">
                                                <form class="form-header" action="" method="POST">
                                                    <h1 class="titulo_modulo">SUPERVISOR - LISTA DE ESTUDIANTES 901 </h1>
                                                    <style>
                                                        .titulo_modulo{
                                                            color: #FFFFFF;
                                                            font-size: 25px;
                                                        ...
                                                        <tbody
                                                            ...
                                                            <tr>                                              
                                                               <!--<td><%=ser.getNombre()%></td>                                               
                                                                ...
                                                                <td> 
                                                                    <a href="Pagina1_supervisor.jsp" class="bttn-unite bttn-sm bttn-danger" data-toggle="tooltip" title="ABRIR BOLETA DE CONSTANCIA">
                                                                        VER BOLETA
                                                                    </a>
                                                                </td>                                               
