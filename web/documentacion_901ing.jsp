...
<%@page import="Modelo.DocumentacionIng"%>
<%@page import="ModeloDAO.DocumentacioningDAO"%>
...
<head>
  ...
  <!-- Bootstrap CSS-->
    ...
    <title> DOCUMENTATION 901 ENG </title>
            ...
            <div class="col-xl-12 col-lg-12" class="tabla_servicio">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                 <h6 class="m-0 font-weight-bold text-primary">¡ List of available documents !</h6>  
                 <a  class="btn btn-primary" href="CrudDocumentacioning?accion=add" >ADD OTHER</a>
                      ...
                      <table class="table" id="testTable" border="1">
                              <thead class="thead-dark">
                                            <tr >
                                                ...
                                                <th>STUDENT ACUDIENT</th>
                                                <th>ENROLLMENT DOCUMENT</th>
                                                <th>HEALTH CERTIFICATE</th>
                                                <th>DOCUMENT BULLETIN</th>
                                                <th>ACTIONS</th>
                                            </tr>
                                        </thead>
                                        <% 
                                           DocumentacioningDAO dao=new DocumentacioningDAO();
                                            List<DocumentacionIng>list=dao.listar();
                                            Iterator<DocumentacionIng>iter=list.iterator();
                                            DocumentacionIng doc=null;
                                            while(iter.hasNext()){
                                            doc=iter.next();
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><%=doc.getMatricula()%></td>
                                                <td><%=doc.getSalud()%></td>
                                                <td><%=doc.getBoletin()%></td>
                                         <td>
                                             <div class="form-group">
                                                <div class="input-icon">
                                                    
                                                    <a class="boton_editar" class="input-icon-addon" href="CrudDocumentacioning?accion=editar&idDocumentacion=<%=doc.getIdDocumentacion()%>" >
                                                        <i title="EDIT" class="fa fa-edit"></i>                         
                                                    </a>         
                                                                                          
                                                    <a class="boton_remover" class="input-icon-addon" href="CrudDocumentacioning?accion=eliminar&idDocumentacion=<%=doc.getIdDocumentacion()%>" >
                                                        <i title="DELETE"  class="fa fa-trash"></i>
                                                    </a>
                                                        
                                                    <a class="boton_subir" class="input-icon-addon" href="subir_doc.jsp" >
