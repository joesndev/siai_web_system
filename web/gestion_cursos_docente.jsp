...
<head>
    ...
    <!-- Title Page-->
    <title> GESTION ACADEMICA CURSOS - DOCENTE </title>
                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="documentacion_docente.jsp">
                                <i class="fas fa-folder-open"></i> Documentacion </a>
                        </li>
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <form class="form-header" action="" method="POST">
                                <h1 class="titulo_modulo"> GESTION ACADEMICA CURSOS - DOCENTE </h1>
                                    <style>
                                        .titulo_modulo{
                                            color: #FFFFFF;
                                            font-size: 25px;
                                ...
                                <div class="table-responsive table--no-card m-b-40">
                                    <table class="table table-striped table-earning">
                                        ...
                                        <tbody>
                                             ...
                                             <tr>
                                                <td> 
                                                    <a class="lista_curso" href="gestion_docente.jsp" />Curso 901</a>
                                                </td>
                                            </tr>

                                            <tr>
                                                <td> 
                                                    <a class="lista_curso" href="gestion_otros_cursos_docente.jsp" />Curso 902</a>
                                                </td>
                                            </tr>

                                            <tr>
                                                <td>
                                                    <a class="lista_curso" href="gestion_otros_cursos_docente.jsp" />Curso 903</a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                ...
                                <div class="au-card au-card--bg-blue au-card-top-countries m-b-40">
                                    <div class="au-card-inner">
                                        <div class="table-responsive">
                                            <table>
                                                <tbody>
                                                <p> En la lista que esta observando puede acceder a los diferentes grados novenos </p> <p> Para  consultar el estado y la informacion de las listas con las actividades de los estudiantes que estan realizando el servicio social estudiantil 
                                                </tbody>
                                            </table>
                                        </div>
                                    </div>
