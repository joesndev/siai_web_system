...
<head>
  ...
  <!-- Bootstrap CSS-->
    ...
    <title> SERVICIO OTROS CURSOS </title>
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <form class="form-header" action="" method="POST">
                                <h1 class="titulo_modulo">LISTA DE ESTUDIANTES OTROS CURSOS</h1>
                                    <style>
                                        .titulo_modulo{
                                            color: #FFFFFF;
                                            font-size: 25px;
                          ...
                          <thead class="thead-dark">
                            ...
                            <tbody
                                     ...
                                     <tr>                                              
                                         ...
                                         <td> 
                                            <a href="Pagina1_cursos.jsp" class="bttn-unite bttn-sm bttn-danger" data-toggle="tooltip" title="ABRIR BOLETA DE CONSTANCIA">
                                                VER BOLETA
                                            </a>
                                         </td>                                               
