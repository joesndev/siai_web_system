...
<head>
  ...
  <!-- Bootstrap CSS-->
    ...
    <title> GESTION OTROS CURSOS </title>
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <form class="form-header" action="" method="POST">
                               <h1 class="titulo_modulo">LISTA DE ACTIVIDADES GESTION OTROS CURSOS</h1>
                                    <style>
                                        .titulo_modulo{
                                            color: #FFFFFF;
                                            font-size: 25px;
            ...
            <div class="card shadow mb-4">
                <form action="CargaMasivaGestion_cursos" enctype="multipart/form-data" method="post"> 
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        ...
                        <!-- BOTON PARA AGREGAR -->
                            <a class="bttn-unite bttn-sm bttn-primary" href="CrudGestion_cursos?accion=add"  data-toggle="tooltip" title="AGREGAR UN NUEVO REGISTRO">
                                AGREGAR
                            </a> &nbsp;  | &nbsp; 
                             ...
                             <tr>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="recurso_otros_cursos.jsp" class="bttn-unite bttn-sm bttn-danger" data-toggle="tooltip" title="ABRIR ARCHIVO DE RECURSO">
                                                        VER DOCUMENTO
                                                    </a><p>
                                            ...
                                            <td>
                                             <div class="form-group">
                                                <div class="input-icon">
                                                    <a class="boton_editar" class="input-icon-addon" href="CrudGestion_cursos?accion=editar&idGestion=<%=ges.getIdGestion()%>" >
