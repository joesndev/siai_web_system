                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <form class="form-header" action="" method="POST">
                                <h1 class="titulo_modulo">  USER LIST </h1>
                                    <style>
                                        .titulo_modulo{
                                            color: #FFFFFF;
                                            font-size: 25px;
                        ...
                        <div class="card shadow mb-4">
                            <form action="CargaMasivaUsuario" enctype="multipart/form-data" method="post">
                                ...
                                <!-- FILTRO = LABEL / INPUT -->
                                        ...
                                        <label class="label_filtrar"> Filter :</label> &nbsp; &nbsp; 
                  ...
                  <div class="chart-area">
                    ...
                    <thead class="thead-dark">
                        <tr class="campo_titulo_lista">
                                        ...
                                        <th class="campo">PHONE</th>
                                        <th class="campo">E-MAIL</th>
                                        <th class="campo">USER TYPE</th>
                                        <th class="campo">DOCUMENT NUMBER</th>
                                        
                                            <!--<th class="campo">CLAVE</th>-->
                                        
                                        <th class="campo">STATUS</th>
                                        ...
                                        <td>
                                             <div class="form-group">
                                                <div class="input-icon">                          
                                                    ...
                                                    <button onClick="mensaje(<%=usu.getIdUsuario()%>)" class="boton_remover" data-toggle="tooltip" class="bttn-slant bttn-md bttn-danger">
