...
<%@page import="Modelo.Servicio_cursos"%>
<%@page import="ModeloDAO.Servicio_cursosDAO"%>
<%@page session="true" %>
...
<head>
  ...
  <!-- Bootstrap CSS-->
    ...
    <title> SUPERVISOR - SERVICIO OTROS CURSOS </title>
                ...
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        <center>
                            ...
                            <hr><br>
                          <li>
                            <a href="servicio_estudiante_lista_supervisor.jsp">
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <form class="form-header" action="" method="POST">
                                <h1 class="titulo_modulo">SUPERVISOR - LISTA DE ESTUDIANTES OTROS CURSOS</h1>
                                    <style>
                                        .titulo_modulo{
                                            color: #FFFFFF;
                                            font-size: 25px;
        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12" class="tabla_servicio">
                <div class="card shadow mb-4">
                    <form action="CargaMasivaServicio_cursos" enctype="multipart/form-data" method="post">
                        ...
                        <!-- BOTON PARA AGREGAR -->
                            <a class="bttn-unite bttn-sm bttn-primary" href="CrudServicio_cursos?accion=add" data-toggle="tooltip" title="AGREGAR UN NUEVO REGISTRO">
                                AGREGAR
                            </a> &nbsp;  | &nbsp; 
...
<div class="dropdown no-arrow">
                          ...
                          <thead class="thead-dark">
                             <tr>
                               ...
                               <%                                             
                                    ...
                                    List<Servicio_cursos>list=dao.listar();                                           
                                    Iterator<Servicio_cursos>iter=list.iterator();                                           
                                    Servicio_cursos ser=null;                                           
                                    while(iter.hasNext()){                                           
                                    ser=iter.next();                                        
                                %>
                            ...
                            <tbody
                                     ...
                                     <tr>                                              
                                         ...
                                         <td> 
                                            <a href="Pagina1_cursos_supervisor.jsp" class="bttn-unite bttn-sm bttn-danger" data-toggle="tooltip" title="ABRIR BOLETA DE CONSTANCIA">
                                                VER BOLETA
                                            </a>
                                         </td>                                               
                        ...
                        <td>
                            <div class="form-group">
                                <div class="input-icon">
                                    ...
                                    <a class="boton_editar" class="input-icon-addon" href="CrudServicio_cursos?accion=editar&idServicioSocial=<%=ser.getIdServicioSocial()%>" >
  ...
  <!-- Script ALERTA ELIMINAR -->
    <script>
        ...
        if (result.value) {
        location.href = "CrudServicio_cursos?accion=eliminar&idServicioSocial=" + idServicioSocial;
        }
        }
                )
    }
