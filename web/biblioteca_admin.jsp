...
<html lang="es">
    ...
    <head>
        ...
        <title> BIBLIOTECA VIRTUAL ADMINISTRADOR </title>
                            ...
                            <ul class="list-unstyled navbar__list">
                                <center>
                                    ...
                                    <li>
                                        ...
                                        <a href="serviciosocial.jsp">
                                            <i class="fas fa-list-alt"></i>Servicio Social</a>
                                    </li>
                            ...
                            <div class="container-fluid">
                                <div class="header-wrap">
                                    <form class="form-header" action="" method="POST">
                                        <h1 class="titulo_modulo">BIBLIOTECA VIRTUAL ADMINISTRADOR </h1>
                                        <style>
                                            .titulo_modulo{
                                                color: #FFFFFF;
                                                font-size: 25px;
                            ...
                            <div class="card shadow mb-4">
                                <form action="MasiveBookData" enctype="multipart/form-data" method="post">
                                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                        ...
                                        <a class="bttn-unite bttn-sm bttn-primary" data-toggle="tooltip" id="mostrar" href="ControllerLibro?action=insert">AGREGAR</a>
                                        | &nbsp; 
                                        <!-- BOTON PARA AGREGAR -->
                                        <a class="bttn-unite bttn-sm bttn-success" href="vista/SIAIbookreport.jsp" data-toggle="tooltip" title="GENERAR REPORTE ESTADÍSTICO">
                                            GRAFICO
                                        </a> &nbsp;  | &nbsp; 

                                        <!-- CARGA DE DATOS MASIVA = BOTON / FILE -->

                                        <input class="bttn-unite bttn-sm bttn-primary" type="submit" name="Subir información" value="CARGAR">
                                        <input class="bttn-unite bttn-sm bttn-primary" type="file" name="fichero" size="70" accept="text/plain;image/jpeg">
                       ...
                       <table id="tblPersonas"  class="table" id="testTable" border="1">
                          <thead class="thead-dark">
                                ...
                                <tr>
                                                    ...
                                                    <th class="campo">DESCRIPCIÓN</th>
                                                    <th class="campo">GENERO</th>
                                                    <th class="campo">AUTOR</th>
                                                    <th class="campo">NUMERO DE CAPITULOS</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        %>
                                                        <a href="pdflibro?Ident=<%=librodto.getCodigopdf()%>" class="bttn-unite bttn-sm bttn-danger" data-toggle="tooltip" title="ABRIR BOLETA DE CONSTANCIA">VER ARCHIVO</a>
                                                        <%
                                                            } else {
                                                                out.print("Vacío");
                                                            }
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class="boton_editar" data-toggle="tooltip"  href="ControllerLibro?action=edit&Ident=<%=librodto.getCodigopdf()%>">
                                                            <i data-toggle="tooltip" title="EDITAR REGISTRO" class="fa fa-edit"></i>
                                                        </a>  
                                                          <button class="boton_remover" onClick="eliminar(<%=librodto.getCodigopdf()%>)" data-toggle="tooltip"  title="Eliminar registro"><i class="fa fa-trash" title="ELIMINAR REGISTRO"></i></button>  
                                                        
                                                        <form action="NotifyBook" method="POST">
                                                            <button name="accion" value="SendNotification" class="boton_enviomasivo" data-toggle="tooltip"  title="ENVIAR ANUNCIO"><i class="fa fa-envelope" ></i></button>  
                                                            <style>
