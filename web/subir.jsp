          ...
          <div class="row">
            ...
            <div class="col-xl-12 col-lg-12" class="tabla_servicio">
              <div class="card shadow mb-4">
                ...
                <h4 class="m-0 font-weight-bold text-primary"> AGREGAR NUEVO DOCUMENTO :  BOLETA FIRMA </h4> 
                    ...
                    <div class="modal-content">
                        <form>
                            ...
                            <div class="modal-body">
                                    <object data="./Archivos/Archivo1.pdf" type="application/pdf" width="480px" height="500px"></object>	
                            </div>
                        </form>    
                    </div>
                </div>
