...
<head>
    ...
    <!-- Title Page-->
    <title>SUPERVISOR - SERVICIO SOCIAL CURSOS </title>
                                ...
                                <div class="table-responsive table--no-card m-b-40">
                                    <table class="table table-striped table-earning">
                                        ...
                                        <tbody>
                                             ...
                                             <tr>
                                                <td> 
                                                    <a class="lista_curso" href="servicio_estudiante_lista_supervisor.jsp" />Curso 901</a>
                                                </td>
                                            </tr>

                                            <tr>
                                                <td> 
                                                    <a class="lista_curso" href="servicio_estudiante_lista_supervisor.jsp" />Curso 902</a>
                                                </td>
                                            </tr>

                                            <tr>
                                                <td>
                                                    <a class="lista_curso" href="servicio_estudiante_lista_supervisor.jsp" />Curso 903</a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
