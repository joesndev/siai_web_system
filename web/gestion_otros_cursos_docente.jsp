...
<head>
  ...
  <!-- Bootstrap CSS-->
    ...
    <title>DOCENTE - GESTION OTROS CURSOS </title>
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <form class="form-header" action="" method="POST">
                               <h1 class="titulo_modulo">DOCENTE - LISTA DE ACTIVIDADES GESTION OTROS CURSOS</h1>
                                    <style>
                                        .titulo_modulo{
                                            color: #FFFFFF;
                                            font-size: 25px;
                             ...
                             <tr>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="recurso.jsp" class="bttn-unite bttn-sm bttn-danger" data-toggle="tooltip" title="ABRIR ARCHIVO DE RECURSO">
                                                        PDF
                                                    </a><p>
