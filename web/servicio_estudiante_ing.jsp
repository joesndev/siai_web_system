                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <form class="form-header" action="" method="POST">
                                <h1 class="titulo_modulo"> LIST OF STUDENT RECORDS </h1>
                                    <style>
                                        .titulo_modulo{
                                            color: #FFFFFF;
                                            font-size: 25px;
                ...
                <div class="card shadow mb-4">
                    <form action="CargaMasivaServicio" enctype="multipart/form-data" method="post">
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            ...
                            <!-- FILTRO = LABEL / INPUT -->
                            <label class="label_filtrar"> Search entity : </label>
                      ...
                      <table id="tblPersonas"  class="table" id="testTable" border="1">
                          <thead class="thead-dark">
                             <tr>
                                 ...
                                 <th class="campo">ACTITY TICKET</th>                                                
                            ...
                            <tbody
                                     ...
                                     <tr>                                              
                                         ...
                                         <td> 
                                            <a href="Pagina1_ing.jsp" class="bttn-unite bttn-sm bttn-danger" data-toggle="tooltip" title="ABRIR BOLETA DE CONSTANCIA">
                                                SEE TICKET
                                            </a>
                                         </td>                                               
