                            ...
                            <div class="container-fluid">
                                <div class="header-wrap">
                                    <form class="form-header" action="" method="POST">
                                        <h1 class="titulo_modulo">BIBLIOTECA DOCENTE </h1>
                                        <style>
                                            .titulo_modulo{
                                                color: #FFFFFF;
                                                font-size: 25px;
...
<div class="dropdown no-arrow">
                                        ...
                                        <table id="tblPersonas"  class="table" id="testTable" border="1">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="campo">Número de Capitulos</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        %>
                                                        <a href="pdflibro?Ident=<%=librodto.getCodigopdf()%>" target="_blank">PDF</a>
                                                        <%
                                                            } else {
                                                                out.print("Vacío");
                                                            }
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class="boton_editar" data-toggle="tooltip" title="Actualizar registro" href="ControllerLibro?action=edit&Ident=<%=librodto.getCodigopdf()%>">
                                                            <i data-toggle="tooltip" title="EDITAR REGISTRO" class="fa fa-edit"></i>
                                                        </a>  
                                                        <button class="boton_remover" onClick="mensaje(<%=librodto.getCodigopdf()%>)" data-toggle="tooltip"  title="Eliminar registro"><i class="fa fa-trash" title="ELIMINAR REGISTRO"></i></button>  
                                                        <form action="NotifyBook" method="POST">
                                                            <button name="accion" value="SendNotification" class="boton_enviomasivo" data-toggle="tooltip"  title="Enviar notificación"><i class="fa fa-envelope" title="NOTIFICAR"></i></button>  
                                                            <style>
        ...
        <script>
            ...
            if (result.value) {
            location.href = "ControllerLibro?action=delete&Ident=" + codigopdf;
            }
            }
            )
            }
