                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="servicio_estudiante.jsp">
                                <i class="fa fa-list-alt"></i>Servicio Social</a>
                        </li>
                        ...
                        <li>
                            ...
                            <i class="fas fa-folder-open"></i> Documentación </a>
                        </li>
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <form class="form-header" action="" method="POST">
                                <h1 class="titulo_modulo">LISTA DE USUARIOS</h1>
                                    <style>
                                        .titulo_modulo{
                                            color: #FFFFFF;
                                            font-size: 25px;
                                    ...
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            ...
                                            <div class="account-dropdown__body">
                                                ...
                                                <div class="account-dropdown__item">
                                                    <a href="envio_masivo.jsp">
                                                        <i class="zmdi zmdi-mail-send"></i>Anuncio Masivo</a>
                                                </div>
                                            </div>
    ...
    <div class="container-fluid">
        <!-- Content Row -->
            <div class="row">
                <!-- Area Chart -->
                    <div class="col-xl-12 col-lg-12" class="tabla_servicio">
                        <div class="card shadow mb-4">
                            <form action="CargaMasivaUsuario" enctype="multipart/form-data" method="post">
                ...
                <!-- BOTON PARA AGREGAR -->
                    <a class="bttn-unite bttn-sm bttn-primary" href="ControladorUsuario?accion=add" >
...
<div class="dropdown no-arrow">
                ...
                <div class="card-body">
                  <div class="chart-area">
                    <center>
                       <table id="tblPersonas" class="table"  border="1">
                    <thead class="thead-dark">
                        <tr class="campo_titulo_lista">
                                        <!--<th class="campo">ID</th>-->
                                        <th class="campo">NOMBRE</th>
                                        <th class="campo">APELLIDO</th>
                                        <th class="campo">TELEFONO</th>
                                        <th class="campo">CORREO</th>
                                        <th class="campo">TIPO DE USUARIO</th>
                                        <th class="campo">NUMERO DE DOCUMENTO</th>
                                        
                                            <!--<th class="campo">CLAVE</th>-->
                                        ...
                                        <td>
                                             <div class="form-group">
                                                <div class="input-icon">
                                                    <a class="boton_editar" class="input-icon-addon" href="ControladorUsuario?accion=editar&idUsuario=<%=usu.getIdUsuario()%>" >
                                                        <i title="EDITAR" class="fa fa-edit"></i>                         
                                                    </a>                           
                                                                
                                                    <button onClick="mensaje(<%=usu.getIdUsuario()%>)" class="boton_remover" data-toggle="tooltip"  title="Eliminar registro" class="bttn-slant bttn-md bttn-danger">
                                                        <i class="fa fa-trash" title="ELIMINAR"></i>
                                                    </button> 
                                                <button onClick="habilitar(<%=usu.getIdUsuario()%>)" class="boton_habilitar" class="input-icon-addon" data-toggle="tooltip"  title="Habilitar Usuario" class="bttn-slant bttn-md bttn-succes">
                                                        <i class="fa fa-plus" title="Habilitar Usuario"></i>
                                                    </button> 
                                                <button onClick="deshabilitar(<%=usu.getIdUsuario()%>)" class="boton_remover" class="input-icon-addon" data-toggle="tooltip"  title="Deshabilitar Usuario" class="bttn-slant bttn-md bttn-succes">
                                                        <i class="fa fa-remove" title="Deshabilitar Usuario"></i>
                                                    </button> 
                                                </div>
  ...
  <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
     ...
     <script>
       ...
       function mensaje(idUsuario) {
        ...
        if (result.value) {
        location.href = "ControladorUsuario?accion=eliminar&idUsuario=" + idUsuario;
        }
        }
                )
    }
    ...
    <script>
       ...
       function habilitar(idUsuario) {
        Swal.fire({
        title: '¿Estas seguro?',
        text: "¡El usuario podra acceder al sistema!",
        type: 'advertencia',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
        ...
        if (result.value) {
        location.href = "ControladorUsuario?accion=Habilitar&idUsuario=" + idUsuario;
        }
        }
                )
    }
    ...
    <script>
       ...
       function deshabilitar(idUsuario) {
        ...
        if (result.value) {
        location.href = "ControladorUsuario?accion=Deshabilitar&idUsuario=" + idUsuario;
        }
        }
                )
    }
