                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <form class="form-header" action="" method="POST">
                                <h1 class="titulo_modulo">ESTUDIANTE - BOLETAS DE CONSTANCIA SERVICIO</h1>
                                    <style>
                                        .titulo_modulo{
                                            color: #FFFFFF;
                                            font-size: 25px;
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                       ...
                       <form action="CargaMasivaServicio" enctype="multipart/form-data" method="post">
                           <label class="label_filtrar"> A continuación encontrará la boleta de constancia del dia de hoy: </label> &nbsp;  &nbsp; 
